...
- What is the version of the Cozy Muzik?
...
```
$ git clone github.com/JosephCaillet/muzik.git
$ cd muzik
$ git remote add fork git://github.com/yourusername/muzik.git
```
...
Go to https://github.com/yourusername/muzik and select your branch. Click the 'Pull Request' button and fill out the form.
...
The Muzik is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/JosephCaillet/muzik/issues/new
...
[localization]: https://github.com/JosephCaillet/muzik/blob/master/README.md#localization
