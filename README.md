[![Travis build status shield](https://img.shields.io/travis/JosephCaillet/muzik/master.svg)](https://travis-ci.org/JosephCaillet/muzik)
[![Github Release version shield](https://img.shields.io/github/tag/JosephCaillet/muzik.svg)](https://github.com/JosephCaillet/muzik/releases)
...
Hacking the Cozy Muzik app requires you to [setup a dev environment][setup].
...
If you want to work on Muzik and submit code modifications, feel free to open pull-requests! See the [contributing guide][contribute] for more information about how to properly open pull-requests.
...
The lead maintainer for Muzik is [JosephCaillet](https://github.com/JosephCaillet), send him/her a :beers: to say hello!
...
Muzik is developed by JosephCaillet and distributed under the [AGPL v3 license][agpl-3.0].
